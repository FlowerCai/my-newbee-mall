  ...
  <div class="product-list-wrap">
    <div class="product-list-content">
      <header class="category-header wrap">
        <i class="iconfont nbiconfanhui" @click="goBack"></i>
...
const {finished,keyword, searchBtn, seclectActive, refreshing, list, loading, productList, totalPage, page, orderBy } = toRefs(state)
