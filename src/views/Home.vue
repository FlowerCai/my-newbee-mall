  ...
  <div>
    <header class="home-header wrap" :class="{'active' : headerScroll}">
      ...
      <div class="header-search">
        <span class="app-name">哆啦A梦的口袋</span>
        <i class="iconfont icon-search"></i>
        <!-- 跳去分类页面 -->
        <router-link tag="span" class="search-title" to="./product-list?from=home">连衣裙</router-link>
      </div>
      <!-- 如果没登录跳转到登录界面 -->
...
const {swiperList, isLogin, headerScroll, hots, newGoodses, recommends, categoryList, loading} = toRefs(state)
